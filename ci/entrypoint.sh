...
#psql -U admin -d demo -h /tmp -c "alter system set lolor.node to ${HOSTNAME: -1};"
...
#echo "lolor.node = ${HOSTNAME: -1}" >> /home/pgedge/pgedge/data/pg16/postgresql.conf
...
#./pgedge db guc-set lolor.node ${HOSTNAME: -1}
