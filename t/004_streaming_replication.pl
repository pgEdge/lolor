# Check streaming replication of pg_lolor large objects
#
...
# Create a pg_lolor large object BEFORE setting up the replica
...
# Create another pg_lolor object on the primary AFTER standby is running
$primary->safe_psql('postgres',
...
is($result, 'pre-backup LO object', "Pre-backup LO available on standby");
